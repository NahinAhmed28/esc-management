...
class ApplicationController extends Controller
{
  ...
  public function index()
  {
    ...
    $applications = Application::with('association','area','branch','category','service', 'serviceType', 'user','file','approval')->whereIn('approval_id',[Admin::PENDING,Admin::APPROVED])->orderBy('id','desc')->utwd()->paginate(100);
  ...
  public function edit(Request $request, $id)
  {
    ...
    $application = Application::with('association','area','branch','category','service','serviceType','user','file')->where(['id'=>$id])->first();
  ...
  {
    $this->authorize('update_approval',Application::class);
    $application = Application::with('association','area','branch','category','service','serviceType','user','file')->where(['id'=>$id])->first();
    if ( is_null($application) == true) {
      return back()->with([
        'error' => __('admin.common.error'),
