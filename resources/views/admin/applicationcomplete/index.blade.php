      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            ...
            <a href="{{ route('admin.applicationdeclined.create') }}" class="btn btn-info form-control btn-add-new">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    {{-- <th>#</th> --}}
                    <th>{{__('admin.applicationdeclined.code')}}</th>
                    <th>{{__('admin.applicationdeclined.area')}}</th>
                    <th>{{__('admin.applicationdeclined.branch')}}</th>
                    <th>{{__('admin.applicationdeclined.service')}}</th>
                    <th>{{__('admin.applicationdeclined.name')}}</th>
                    <th>{{__('admin.applicationdeclined.contact')}}</th>
                    <th>{{__('admin.applicationdeclined.passport')}}</th>
                    <th>{{__('admin.applicationdeclined.nid')}}</th>
                    <th>{{__('admin.applicationdeclined.approval')}}</th>

                    <th>{{__('admin.applicationdeclined.dob')}}</th>
                    <th>{{__('admin.applicationdeclined.gender')}}</th>
                    <th>{{__('admin.applicationdeclined.father')}}</th>
                    <th>{{__('admin.applicationdeclined.address')}}</th>

                    <th>{{__('admin.applicationdeclined.dsign')}}</th>
                    <th>{{__('admin.common.attachment')}}</th>
                    <th>{{__('admin.applicationdeclined.created_at')}}</th>
                    <th>{{__('admin.applicationdeclined.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.applicationdeclined.edit_approval', $application->id) }}" class="btn btn-xs btn-primary">
                    ...
                    <td>
                      @can('update', app('App\Models\Applicationdeclined'))
                        <a href="{{ route('admin.applicationdeclined.edit', $application->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      @endcan
                      
                      @can('delete', app('App\Models\Applicationdeclined'))
                        <a href="{{ route('admin.applicationdeclined.delete', $application->id) }}" href1="{{ route('admin.applicationdeclined.delete', [$application->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
