...
<div class="content-wrapper">
    ...
    <form class="form-edit-add" application="form" id="application_entry_form"
        action="{{ !$edit ? route('admin.applicationdeclined.store') : route('admin.applicationdeclined.update', $application->id) }}"
                            ...
                            <div class="card-body">
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="area_id">{{ __('admin.applicationdeclined.area') }}<!--<span style="color: red"> * </span>--></label>
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="branch_id">{{ __('admin.applicationdeclined.branch') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="service_id">{{ __('admin.applicationdeclined.service') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                <div class="form-group">
                                    <label for="title_en">{{ __('admin.applicationdeclined.title_en') }}</label>
                                    <input type="text" name="title_en" id="title_en"
                                        placeholder="{{ __('admin.applicationdeclined.title_en') }}"
                                        value="{{ $edit?$application->title_en:old('title_en') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="title_bn">{{ __('admin.applicationdeclined.title_bn') }}</label>
                                    <input type="text" name="title_bn" id="title_bn"
                                        placeholder="{{ __('admin.applicationdeclined.title_bn') }}"
                                        value="{{ $edit?$application->title_bn:old('title_bn') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="contact">{{ __('admin.applicationdeclined.contact') }}</label>
                                    <input type="text" name="contact" id="contact"
                                        placeholder="{{ __('admin.applicationdeclined.contact') }}"
                                        value="{{ $edit?$application->contact:old('contact') }}"
                                        class="form-control" minlength="11" maxlength="15" onkeypress='validate(event)'>
                                </div>

                                <div class="form-group">
                                  <label for="passport">{{ __('admin.applicationdeclined.passport') }}</label>
                                  <input type="text" name="passport" id="passport"
                                      placeholder="{{ __('admin.applicationdeclined.passport') }}"
                                      value="{{ $edit?$application->passport:old('passport') }}"
                                      class="form-control" minlength="11" maxlength="15" onkeypress='validate(event)'>
                                </div>

                                <div class="form-group">
                                    <label for="dob">{{ __('admin.applicationdeclined.dob') }} </label>
                                    <input type="text" name="dob" id="dob"
                                        placeholder="{{ __('admin.applicationdeclined.dob') }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="email">{{ __('admin.applicationdeclined.email') }}</label>
                                    <input type="email" name="email" id="email"
                                        placeholder="{{ __('admin.applicationdeclined.email') }}"
                                        value="{{ $edit?$application->email:old('email') }}"
                                        class="form-control">
                                </div>

                                <div class="form-group">
                                    <label for="nid">{{ __('admin.applicationdeclined.nid') }}</label>
                                    <input type="text" name="nid" id="nid"
                                        placeholder="{{ __('admin.applicationdeclined.nid') }}"
                                ...
                                <div class="form-group">
                                    <label for="title_bn"
                                        style="padding-right:20%;padding-top: 3%;">{{ __('admin.applicationdeclined.gender') }}
                                        : </label>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="1"
                                                {{ ($edit && ($application->gender)) ? 'checked' : '' }}>{{ __('admin.applicationdeclined.male') }}
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="gender" value="0"
                                                {{ ($edit && (!$application->gender)) ? 'checked' : '' }}>{{ __('admin.applicationdeclined.female') }}
                                        </label>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label for="title_bn"
                                        style="padding-right:8%;padding-top: 3%;">{{ __('admin.applicationdeclined.marital') }}: </label>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="marital" value="1"
                                                {{ ($edit && ($application->marital)) ? 'checked' : '' }}>{{ __('admin.applicationdeclined.married') }}
                                        </label>
                                    </div>
                                    <div class="form-check-inline">
                                        <label class="form-check-label">
                                            <input type="radio" class="form-check-input" name="marital" value="0"
                                                {{ ($edit && (!$application->marital)) ? 'checked' : '' }}>{{ __('admin.applicationdeclined.unmarried') }}
                                        </label>
                                    </div>
                                </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                    <label
                                        for="address_en">{{ __('admin.applicationdeclined.address_en') }}</label>
                                    <textarea rows="1" id="address_en" class="form-control"
                                        placeholder="{{ __('admin.applicationdeclined.address_en') }}"
                                        name="address_en"
                                ...
                                <div class="form-group">
                                    <label
                                        for="address_bn">{{ __('admin.applicationdeclined.address_bn') }}</label>
                                    <textarea rows="1" id="address_bn" class="form-control"
                                        placeholder="{{ __('admin.applicationdeclined.address_bn') }}"
                                        name="address_bn"
                                        required>{{ $edit?$application->address_bn:old('address_bn') }}</textarea>
                                </div>
                                <div class="form-group">
                                    <label
                                        for="father_en">{{ __('admin.applicationdeclined.father_en') }}</label>
                                    <input type="text" name="father_en" id="father_en"
                                        placeholder="{{ __('admin.applicationdeclined.father_en') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="father_bn">{{ __('admin.applicationdeclined.father_bn') }}</label>
                                    <input type="text" name="father_bn" id="father_bn"
                                        placeholder="{{ __('admin.applicationdeclined.father_bn') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="spouse_en">{{ __('admin.applicationdeclined.spouse_en') }}</label>
                                    <input type="text" name="spouse_en" id="spouse_en"
                                        placeholder="{{ __('admin.applicationdeclined.spouse_en') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="spouse_bn">{{ __('admin.applicationdeclined.spouse_bn') }}</label>
                                    <input type="text" name="spouse_bn" id="spouse_bn"
                                        placeholder="{{ __('admin.applicationdeclined.spouse_bn') }}"
                                ...
                                <div class="form-group">
                                    <label for="dsign">
                                        {{ __('admin.applicationdeclined.dsign') }} <span
                                            class="text-warning">
