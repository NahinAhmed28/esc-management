      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            ...
            <a href="{{ route('admin.applicationcomplete.create') }}" class="btn btn-info form-control btn-add-new">
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    {{-- <th>#</th> --}}
                    <th>{{__('admin.applicationcomplete.code')}}</th>
                    <th>{{__('admin.applicationcomplete.area')}}</th>
                    <th>{{__('admin.applicationcomplete.branch')}}</th>
                    <th>{{__('admin.applicationcomplete.service')}}</th>
                    <th>{{__('admin.applicationcomplete.name')}}</th>
                    <th>{{__('admin.applicationcomplete.contact')}}</th>
                    <th>{{__('admin.applicationcomplete.passport')}}</th>
                    <th>{{__('admin.applicationcomplete.nid')}}</th>
                    <th>{{__('admin.applicationcomplete.approval')}}</th>

                    <th>{{__('admin.applicationcomplete.dob')}}</th>
                    <th>{{__('admin.applicationcomplete.gender')}}</th>
                    <th>{{__('admin.applicationcomplete.father')}}</th>
                    <th>{{__('admin.applicationcomplete.address')}}</th>

                    <th>{{__('admin.applicationcomplete.dsign')}}</th>
                    <th>{{__('admin.common.attachment')}}</th>
                    <th>{{__('admin.applicationcomplete.created_at')}}</th>
                    <th>{{__('admin.applicationcomplete.action')}}</th>
                  </tr>
                  </thead>
                  <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.applicationcomplete.edit_approval', $application->id) }}" class="btn btn-xs btn-primary">
                    ...
                    <td>
                      @can('update', app('App\Models\Applicationcomplete'))
                        <a href="{{ route('admin.applicationcomplete.edit', $application->id) }}" class="btn btn-xs btn-primary"><i class="fas fa-edit"></i></a>
                      @endcan
                      
                      @can('delete', app('App\Models\Applicationcomplete'))
                        <a href="{{ route('admin.applicationcomplete.delete', $application->id) }}" href1="{{ route('admin.applicationcomplete.delete', [$application->id,1]) }}" class="btn btn-xs btn-danger delete"><i class="fas fa-trash-alt"></i></a>
                      @endcan
