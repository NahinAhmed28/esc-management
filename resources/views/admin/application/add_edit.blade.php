                            ...
                            <div class="card-body">
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="area_id">{{ __('admin.application.area') }}<!--<span style="color: red"> * </span>--></label>
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="branch_id">{{ __('admin.application.branch') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                @if($edit)
                                    <div class="form-group">
                                        <label for="service_id">{{ __('admin.application.service') }} <!--<span style="color: red"> * </span>--></label>
                                ...
                                <div class="form-group">
                                    <label for="title_en">{{ __('admin.application.title_en') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="title_bn">{{ __('admin.application.title_bn') }}</label>
                                ...
                                <div class="form-group">
                                    <label for="contact">{{ __('admin.application.contact') }}</label>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                              ...
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                    <label
                                        for="father_en">{{ __('admin.application.father_en') }}</label>
                                    <input type="text" name="father_en" id="father_en"
                                        placeholder="{{ __('admin.application.father_en') }}"
                                ...
                                <div class="form-group">
                                    <label
                                        for="father_bn">{{ __('admin.application.father_bn') }}</label>
                                    <input type="text" name="father_bn" id="father_bn"
                                        placeholder="{{ __('admin.application.father_bn') }}"
                                ...
                                {{-- @if($edit)
                                    <div class="form-group">
                                        <label for="approval_id">{{ __('admin.application.approval') }}<!--<span style="color: red"> * </span>--></label>
        ...
        $(add_button).click(function (e) {
            ...
            if (x < max_fields) {
                ...
                $(wrapper).append('<div class="row">' +
                    '<div class="col-md-5">' +
                      '<div class="form-group">' +
                        '<input type="text" name="arraydata[file'+ x +'][name]" id="name'+ x +'" placeholder="{{ __('admin.application.file_title') }}" value="" class="form-control">' +
                      '</div>' +
                    '</div>' +
                    '<div class="col-md-5">' +
                      '<div class="form-group">' +
