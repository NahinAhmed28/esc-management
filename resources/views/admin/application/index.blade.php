      ...
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-2">
            ...
            <a href="{{ route('admin.application.create') }}" class="btn btn-info form-control btn-add-new">
              ...
              <div class="card-body">
                <table id="example2" class="table table-bordered table-hover">
                  ...
                  <tr>
                    ...
                    <th>{{__('admin.application.area')}}</th>
                    <th>{{__('admin.application.branch')}}</th>
                    <th>{{__('admin.application.service')}}</th>
                    <th>{{__('admin.application.name')}}</th>
                    <th>{{__('admin.application.contact')}}</th>
                    <th>{{__('admin.application.passport')}}</th>
                    <th>{{__('admin.application.nid')}}</th>
                    <th>{{__('admin.application.approval')}}</th>

                    <th>{{__('admin.application.dob')}}</th>
                    <th>{{__('admin.application.gender')}}</th>
                    <th>{{__('admin.application.father')}}</th>
                    <th>{{__('admin.application.address')}}</th>

                    <th>{{__('admin.application.dsign')}}</th>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="{{ route('admin.application.edit_approval', $application->id) }}" class="btn btn-xs btn-primary">
